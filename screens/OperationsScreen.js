...
function OperationsScreen({
    ...
    const saveOperation = () => {
        ...
        // Verificar se a mobilização foi concluída
    ...
    return (
        <ScrollView style={globalStyles.scrollView}>
            ...
            <View style={globalStyles.section}>
                ...
                <View style={globalStyles.formGroup}>
                    <Text style={globalStyles.label}>Operador *</Text>
                    <TextInput
                        style={globalStyles.input}
                ...
                <TouchableOpacity
                    style={[globalStyles.button, (!operationStart || !mobilizationEndTime) && globalStyles.disabledButton]}
                    onPress={saveOperation}
                    disabled={!operationStart || !mobilizationEndTime}
                >
